...
def admin_dashboard_view(request):
    ...
    return render(request,'shoeshop/admin_dashboard.html',context=mydict)
...
def update_customer_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            customerForm.save()
            return redirect('view-customer')
    return render(request,'shoeshop/admin_update_customer.html',context=mydict)
...
def update_product_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if productForm.is_valid():
            productForm.save()
            return redirect('admin-products')
    return render(request,'shoeshop/admin_update_product.html',{'productForm':productForm})
...
def admin_view_booking_view(request):
    ...
    for order in orders:
        ...
        ordered_products.append(ordered_product)
        ordered_bys.append(ordered_by)
    return render(request,'shoeshop/admin_view_booking.html',{'data':zip(ordered_products,ordered_bys,orders)})
...
def update_order_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if orderForm.is_valid():
            orderForm.save()
            return redirect('admin-view-booking')
    return render(request,'shoeshop/update_order.html',{'orderForm':orderForm})
...
def view_feedback_view(request):
    ...
    return render(request,'shoeshop/view_feedback.html',{'feedbacks':feedbacks})
...
def add_to_cart_view(request,pk):
    ...
    response = render(request, 'shoeshop/index.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def cart_view(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        if product_ids != "":
            ...
            for p in products:
                total=total+p.price
    return render(request,'shoeshop/cart.html',{'products':products,'total':total,'product_count_in_cart':product_count_in_cart})
...
def remove_from_cart_view(request,pk):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        response = render(request, 'shoeshop/cart.html',{'products':products,'total':total,'product_count_in_cart':product_count_in_cart})
        if value=="":
...
def send_feedback_view(request):
    ...
    if request.method == 'POST':
        ...
        if feedbackForm.is_valid():
            feedbackForm.save()
            return render(request, 'shoeshop/feedback_sent.html')
    return render(request, 'shoeshop/send_feedback.html', {'feedbackForm':feedbackForm})
...
def customer_home_view(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'shoeshop/customer_home.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def customer_address_view(request):
    ...
    if request.method == 'POST':
        ...
        if addressForm.is_valid():
            ...
            response = render(request, 'shoeshop/payment.html',{'total':total})
            response.set_cookie('email',email)
            response.set_cookie('mobile',mobile)
            response.set_cookie('address',address)
            return response
    return render(request,'shoeshop/customer_address.html',{'addressForm':addressForm,'product_in_cart':product_in_cart,'product_count_in_cart':product_count_in_cart})
...
def payment_success_view(request):
    ...
    response = render(request,'shoeshop/payment_success.html')
    response.delete_cookie('product_ids')
...
def my_order_view(request):
    ...
    return render(request,'shoeshop/my_order.html',{'data':zip(ordered_products,orders)})
...
#     else:
#         product_count_in_cart=0
#     return render(request,'shoeshop/my_order.html',{'products':products,'product_count_in_cart':product_count_in_cart})    
...
def download_invoice_view(request,orderID,productID):
    ...
    return render_to_pdf('shoeshop/download_invoice.html',mydict)
...
def edit_profile_view(request):
    ...
    return render(request,'shoeshop/edit_profile.html',context=mydict)
...
def aboutus_view(request):
    return render(request,'shoeshop/aboutus.html')
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            return render(request, 'shoeshop/contactussuccess.html')
    return render(request, 'shoeshop/contactus.html', {'form':sub})
