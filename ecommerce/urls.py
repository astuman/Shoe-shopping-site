...
urlpatterns = [
    ...
    path(
        'logout',
        LogoutView.as_view(
            template_name='shoeshop/logout.html'),
        name='logout'),
    ...
    path(
        'adminlogin',
        LoginView.as_view(
            template_name='shoeshop/adminlogin.html'),
        name='adminlogin'),
    path(
        'admin-dashboard',
    ...
    path('admin-brands', views.admin_brand_view, name='admin-brands'),
    path(
        'admin-add-brand',
        views.admin_add_brand_view,
        name='admin-add-brand'),


    path(
        'admin-view-booking',
        views.admin_view_booking_view,
    ...
    path(
        'login',
        LoginView.as_view(
            template_name='shoeshop/login.html'),
        name='login'),
