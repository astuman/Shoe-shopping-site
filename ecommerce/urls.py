...
urlpatterns = [
    ...
    path('logout', LogoutView.as_view(template_name='shoeshop/logout.html'),name='logout'),
    ...
    path('adminlogin', LoginView.as_view(template_name='shoeshop/adminlogin.html'),name='adminlogin'),
    ...
    path('admin-add-brand', views.admin_add_brand_view,name='admin-add-brand'),
